...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/**/list", "/api/**/list/**").hasRole(RolesEnum.PORTAL.name())
                .antMatchers(HttpMethod.GET,"/api/**").hasRole(RolesEnum.PORTAL.name())
                .antMatchers("/api/**").hasRole(RolesEnum.PORTAL.name())
